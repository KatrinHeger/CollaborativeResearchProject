...
## Outlook
Due to the structure of the multinomial logit estimation, it is very complicated to interprete the effects from the above inserted tables. In future analysis, we thus will have to evaluate the statistical significance of each independent variable. Moreover, intervention into a conflict and military strength might vary within one conflict dyad. This variation could be accounted for by switching the unit of analysis from conflict dyads to conflict dyad years. 
