...
Table 1 displays the results of three multinomial logit estimations. Model 1 regresses our main explanatory variable, the type of support to government, on the dependet variable conflict outcome. Model 2 adds as a further explanatory variable the relative figting capacity of rebels and the interaction term. In Model 3, we include our set of control variables.    
In our full model, we see that 
...
Identical to the multinomial regression above, we step-by-step added variables to the main explanatory factor, support to rebels. Models 1 to 3 are displayed in table 2.  
...
##Control Variables
Similar to Sullivan and Karreth's findings, we see a 
...
stargazer::stargazer(mlogit3_complete, type = 'latex', digits = 2, header = FALSE, dep.var.labels = rep(c('Rebel Victory', 'Negotiation', 'Gov. Victory'), 3), covariate.labels=c('Gov. S. Troops', 'Gov. S. Military', 'Gov. S. Non-military', 'Rebel S. Military', 'Rebel S. Non-military', 'Fighting Capacity','Interaction GovXFi', 'GDP', 'Duration', 'Reb. Legal Wing', 'Secessionist'))
